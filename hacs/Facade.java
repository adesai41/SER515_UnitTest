...
public class Facade {
    ...
    void addAssignment(Course theCourse) throws Exception {
...
//functions for InstructorAssignmentMenu
    ...
    void createCourseList() throws IOException {
        ...
        theCourseList.InitializeFromFile("/Users/aakankshadesai/Downloads/hacs/hacs/Courses.txt");
    }
    ...
    void attachCourseToUser() throws IOException {
        ...
        file = new BufferedReader(new FileReader("/Users/aakankshadesai/Downloads/hacs/hacs/UserCourse.txt"));
